...
""" create/edit TraceAnnotation record 
    i.e. place in collection, when, why
"""
# def trace_annotater(request, *args, **kwargs):
#   cid = kwargs.get('cid') # collection.id
#   pid = kwargs.get('pid') # place id
#   place = get_object_or_404(Place, pk=pid)
#
#   Form = modelform_factory(
#     TraceAnnotation, form=TraceAnnotationModelForm, fields=fields
#   )
#
